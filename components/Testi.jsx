...
const Testi = ({heading1, heading2, message1, message2, message3 }) => {
  return (
    <div className='flex items-center justify-center h-screen mt-0 bg-fixed bg-center bg-cover bg-cover custom-img-mob md:custom-img'>
        {/* Overlay */}
        <div className='absolute top-0 left-0 right-0 bottom-0 bg-dkgrey/70 z-[2]' />
        <div className='p-5 text-white z-[2] mt-[4rem] mx-[6%] sm:mr-[15%] sm:ml-[25%] '>
            <div>
